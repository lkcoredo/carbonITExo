...
public class TreasureTracker {
    ...
    public static void writeOutputFile(Map map, String filePath) {
        ...
        try {
            ...
            for (Adventurer adventurer : map.adventurers) {
                writer.write(String.format("A - %s - %d - %d - %s - %d\n", adventurer.name, adventurer.x, adventurer.y, adventurer.orientation, adventurer.treasuresCollected));
            }
...
public class Main {
    public static void main(String[] args) {
        ...
        map.addTreasure(1, 3, 1);

        // Création des aventuriers
        Adventurer indiana = new Adventurer("Indiana", 1, 1, Orientation.SOUTH, "AADADA");
        Adventurer lara = new Adventurer("Lara", 2, 2, Orientation.EAST, "DADAA");

        // Ajout des aventuriers sur la carte
        map.addAdventurer(indiana);
